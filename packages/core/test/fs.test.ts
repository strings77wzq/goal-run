...
describe('safe filesystem utilities', () => {
  ...
  describe('readFileSafe', () => {
    ...
    it('throws on path traversal read attempt', async () => {
      await expect(readFileSafe(repoRoot, '../secret.txt')).rejects.toThrow(/outside repo root/i);
    });
  ...
  describe('fileExists', () => {
    ...
    it('throws on path traversal', async () => {
      await expect(fileExists(repoRoot, '../etc/passwd')).rejects.toThrow(/outside repo root/i);
    });
  });
  ...
  describe('ensureDir', () => {
    ...
    it('throws on path traversal', async () => {
      await expect(ensureDir(repoRoot, '../escape')).rejects.toThrow(/outside repo root/i);
    });
  });
  ...
  describe('readYamlSafe', () => {
    ...
    it('throws on path traversal', async () => {
      await expect(readYamlSafe(repoRoot, '../secret.yaml')).rejects.toThrow(/outside repo root/i);
    });
  });
