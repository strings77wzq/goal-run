...
import { type Lockfile, createLockfile, addSkillToLockfile, computeSkillHash } from 'goalrun-core';
...
function updateLockfile(repoRoot: string, lockfilePath: string, installed: string[]): void {
