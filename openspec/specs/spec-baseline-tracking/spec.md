...
Define how OpenSpec specs and change artifacts are retained as versioned project governance assets while runtime state and build artifacts remain ignored.
